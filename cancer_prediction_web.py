...
def cancer_prediction(input_data):
    ...
    if (prediction[0] == 0):
      return 'you have a low chance of cancer'
    else:
      return 'unfortunately you have a high chance of cancer, it is advised you book an appointment with an oncologist from the app'
